...
source = '/home/kos/OUTPUT'
inputfile = 'output.log'
dest = 'files'
video_url = 'http://duroscope.ru:8000/video.html'
static_url = 'http://duroscope.ru:8000'
...
for line in lststr:
  ...
  mas = line.split('|')
  if len(mas) == 13:
    # копирование файлов poster, torrent
    ...
    if os.path.exists(dest+'/'+dir+'/'+dir+'.torrent'):
      ...
      mas1.append(mas[8])
      mas1.append(mas[9])
      mas1.append(static_url+'/'+dir+'/'+os.path.basename(mas[10]))
      mas1.append(video_url)
      #mas1.append(static_url+'/'+dir+'/'+mas[12])
      mas1.append(static_url+'/'+dir+'/'+dir+'.torrent')
      in_baza = tuple(mas1)
      #print in_baza
